...
SWIFT_MODULE_NAMESPACE_PUSH("CropViewController")
@class NSCoder;
@class NSBundle;
...
/// @param cropRect A rectangle indicating the crop region of the image the user chose (In the original image’s local co-ordinate space)
/// @param angle The angle of the image when it was cropped
- (void)cropViewController:(CropViewController * _Nonnull)cropViewController didCropToImage:(UIImage * _Nonnull)image withRect:(CGRect)cropRect angle:(NSInteger)angle;
...
/// @param cropRect A rectangle indicating the crop region of the image the user chose (In the original image’s local co-ordinate space)
/// @param angle The angle of the image when it was cropped
- (void)cropViewController:(CropViewController * _Nonnull)cropViewController didCropToCircularImage:(UIImage * _Nonnull)image withRect:(CGRect)cropRect angle:(NSInteger)angle;
...
- (void)cropViewController:(CropViewController * _Nonnull)cropViewController didFinishCancelled:(BOOL)cancelled;
@end
